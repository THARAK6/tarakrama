...
export const DATA = {
  ...
  contact: {
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/tharak6",
        icon: Icons.github,
        navbar: true,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/tarakarama/",
        icon: Icons.linkedin,
        navbar: true,
      },
    },
  ...
  projects: [
    {
      ...
      description:
        "",
      iconLists: ["/autodeskrevit-color.svg", "/a.jpeg", "/n.jpeg"],
      links: [
